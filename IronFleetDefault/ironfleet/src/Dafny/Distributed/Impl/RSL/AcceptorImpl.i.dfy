...
module LiveRSL__AcceptorModel_i {
  ...
  // method sum_set(s: set<int>) returns (i: int)
  //   ensures sum(s) == i
  // {
  //   if |s| == 0 {
  //     i := 0;
  ...
  // method update_set(s:set<int>) returns (i:int)
  //   ensures update(s) == i
  // {
  //   if |s| == 0 { 
  //     i := 0;
  ...
  //   else {
  //     var x:int :| x in s;
  //     var r := update_set(s-{x});
  //     assert r == update(s-{x});
  //     i := r;
  //     assert update(s) == update(s-{x});
  //     assert i == update(s);
  //   }
  // }
